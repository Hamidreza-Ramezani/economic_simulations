...
import meta.example.supermarket.people.{ImpulseShopper, MealPlan3, People, Weekly}
...
@lift
class Customer3 (var supermarket: SupermarketTrait) extends People with Weekly with MealPlan3 with ImpulseShopper {
