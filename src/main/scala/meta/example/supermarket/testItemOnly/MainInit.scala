...
//    sectionList1 += sectionGrain1
    ...
    val item1_1_TerraSuisse = new Item1(supermarket1, sectionVegetable1, worldMap, TerraSuisse, global.priceMap(("Item1", TerraSuisse)))
    val item2_1_TerraSuisse = new Item2(supermarket1, sectionVegetable1, worldMap, TerraSuisse, global.priceMap(("Item2", TerraSuisse)))
    val item3_1_TerraSuisse = new Item3(supermarket1, sectionVegetable1, worldMap, TerraSuisse, global.priceMap(("Item3", TerraSuisse)))
    val item4_1_TerraSuisse = new Item4(supermarket1, sectionVegetable1, worldMap, TerraSuisse, global.priceMap(("Item4", TerraSuisse)))
    val item5_1_TerraSuisse = new Item5(supermarket1, sectionVegetable1, worldMap, TerraSuisse, global.priceMap(("Item5", TerraSuisse)))
    val item6_1_TerraSuisse = new Item6(supermarket1, sectionVegetable1, worldMap, TerraSuisse, global.priceMap(("Item6", TerraSuisse)))
    val item7_1_TerraSuisse = new Item7(supermarket1, sectionVegetable1, worldMap, TerraSuisse, global.priceMap(("Item7", TerraSuisse)))
    val item8_1_TerraSuisse = new Item8(supermarket1, sectionVegetable1, worldMap, TerraSuisse, global.priceMap(("Item8", TerraSuisse)))
    val item9_1_TerraSuisse = new Item9(supermarket1, sectionVegetable1, worldMap, TerraSuisse, global.priceMap(("Item9", TerraSuisse)))
    val item10_1_TerraSuisse = new Item10(supermarket1, sectionVegetable1, worldMap, TerraSuisse, global.priceMap(("Item10", TerraSuisse)))
    val item11_1_TerraSuisse = new Item11(supermarket1, sectionVegetable1, worldMap, TerraSuisse, global.priceMap(("Item11", TerraSuisse)))
