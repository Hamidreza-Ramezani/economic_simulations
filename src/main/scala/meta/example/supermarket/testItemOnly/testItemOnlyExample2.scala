...
////import meta.example.supermarket.goods.{Grain, Meat, Snack, Vegetable, _}
//import meta.example.supermarket.goods_updated.{Dairy, Grain, Meat, Snack, Vegetable}
//import meta.example.supermarket.people._
//
//object testItemOnlyExample2 extends App {
//  val mainClass: ClassWithObject[MainInit2] = MainInit2.reflect(IR)
