...
//  }
//
//  farmer.writer = new PrintWriter(new FileWriter(new File("m/agentFarmer")))
//
//
...
//    farmer.move(worldMap, pickedSupermarket)
//    var farmerX = farmer.currentXPosition
//    var farmerY = farmer.currentYPosition
//    assert(farmer.currentXPosition == pickedSupermarket.currentXPosition)
//    assert(farmer.currentYPosition == pickedSupermarket.currentYPosition)
//    worldMap.coordinates(farmerY)(farmerX).actors.contains(farmer)
//    worldMap.coordinates(farmerY)(farmerX).actors.contains(pickedSupermarket)
//  }
//
//  "we should have access to tiles through actors" should "work" in {
//    println(farmer.getCurrentTile(worldMap).toString3)
//    println(supermarket1.getCurrentTile(worldMap).toString3)
//    assert(farmer.getCurrentTile(worldMap) == supermarket1.getCurrentTile(worldMap))
//  }
//}